        ...
        >
            {userName ? (
                <div>
                    ...
                    {data.length > 0 ? (
                        <div className="mt-6 bg-white shadow-md rounded-lg p-6 text-gray-700 w-full max-w-4xl mx-auto overflow-x-auto">
                                ...
                                <tbody>
                                    {data.map((item, index) => (
                                        <tr key={index} className="border-b">
                                            <td className="px-6 py-4">{new Date(item.fecha).toISOString().split("T")[0]}</td>
